import '../see_more_7_screen/widgets/group610_item_widget.dart';
                                ...
                                child: Padding(
                                  ...
                                  child: Obx(
                                    () => GridView.builder(
                                      ...
                                      itemCount: controller.seeMore7ModelObj
                                          .value.group610ItemList.length,
                                      itemBuilder: (context, index) {
                                        Group610ItemModel model = controller
                                            .seeMore7ModelObj
                                            .value
                                            .group610ItemList[index];
                                        return Group610ItemWidget(
                                          model,
                                        );
                                      },
                                    ),
