                                                                    ...
                                                                    children: [
                                                                      ClipRRect(
                                                                          borderRadius: BorderRadius.circular(getHorizontalSize(
                                                                              2)),
                                                                          child: Image.asset(
                                                                              ImageConstant.img_thumbnailimage_41,
                                                                              height: getVerticalSize(161.56),
                                                                              width: getHorizontalSize(120),
                                                                              fit: BoxFit.fill)),
                                                                      Expanded(
                                                                          child: Padding(
                                                                              padding: EdgeInsets.only(left: getHorizontalSize(16), top: getVerticalSize(19), bottom: getVerticalSize(28)),
                                                                              child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                                Padding(padding: EdgeInsets.only(right: getHorizontalSize(96)), child: Text("lbl_high_life".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.textStyleRobotoregular24.copyWith(fontSize: getImageSize(24), letterSpacing: 0))),
                                                                                Padding(
                                                                                      ...
                                                                                      Expanded(
                                                                                          child: Padding(
                                                                                              ...
                                                                                              child: Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.end, children: [
                                                                                                ...
                                                                                                Padding(padding: EdgeInsets.only(left: getHorizontalSize(10), top: getVerticalSize(6), right: getHorizontalSize(73), bottom: getVerticalSize(4)), child: Container(height: getVerticalSize(6.62), width: getHorizontalSize(6), child: SvgPicture.asset(ImageConstant.img_staricon_4, fit: BoxFit.fill)))
                                                                                              ])))
                                                                                    ])),
                                                                                Padding(
                                                                                    padding: EdgeInsets.only(top: getVerticalSize(16)),
                                                                                      ...
                                                                                      Card(
                                                                                          ...
                                                                                          child: Padding(
                                                                                              ...
                                                                                              child: Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
                                                                                                Padding(padding: EdgeInsets.only(left: getHorizontalSize(17), top: getVerticalSize(1), bottom: getVerticalSize(1)), child: Container(height: getImageSize(14), width: getImageSize(14), child: SvgPicture.asset(ImageConstant.img_playicon_3, fit: BoxFit.fill))),
                                                                                                Expanded(child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(6), right: getHorizontalSize(6)), child: Text("lbl_watch_now".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, style: AppStyle.textStyleRobotoregular14.copyWith(fontSize: getImageSize(14), letterSpacing: 0))))
                                                                                              ]))),
                                                                                      Padding(padding: EdgeInsets.only(left: getHorizontalSize(10)), child: Container(height: getImageSize(36), width: getImageSize(36), child: SvgPicture.asset(ImageConstant.img_stareicon, fit: BoxFit.fill)))
                                                                                    ]))
                                                                              ])))
                                                                    ])),
                                                            Padding(
                                                            ...
                                                            Padding(
                                                                ...
                                                                child: Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Expanded(
                                                                          child: Padding(
                                                                              padding: EdgeInsets.only(left: getHorizontalSize(16), bottom: getVerticalSize(1)),
                                                            ...
                                                            Padding(
                                                                ...
                                                                child: Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Expanded(
                                                                          child: Padding(
                                                                              padding: EdgeInsets.only(left: getHorizontalSize(16), top: getVerticalSize(2), bottom: getVerticalSize(1)),
